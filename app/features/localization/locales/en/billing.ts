...
export default {
  ...
  billingSuccessPage: {
    ...
    thankYou:
      "Thank you for trusting Ren Studio. Your successful journey towards building and maintaining a SaaS product starts now!",
  },
  contactSales: {
    company: "Company",
  ...
  pricingPage: {
    pageDescription:
      "Obviously Ren Studio is free. But this is what your pricing could look like.",
    pageTitle: "Pricing",
