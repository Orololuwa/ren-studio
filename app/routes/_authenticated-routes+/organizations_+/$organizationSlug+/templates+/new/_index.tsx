...
export async function loader({ params }: Route.LoaderArgs) {
  ...
  // return redirect(`/organizations/${params.organizationSlug}/templates/${savedTemplate.id}`);
}
